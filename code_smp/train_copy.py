...
def main():
    ...
    dsc_loss = smp.utils.losses.MSELoss()
    # dsc_loss = DiceLoss()

    # model = UNet(in_channels=21, out_channels=4, init_features=128)
    model = smp.Unet('resnet18', encoder_weights='imagenet',in_channels=21, classes=4, activation=None)
    model.cuda()
    ...
    save_model_path = '../checkpoints/resnet18-copy.pk'
    load_model_path = '../checkpoints/resnet18-copy.pk'
